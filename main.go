...
import (
	...
	envcontrollers "github.com/RuslanMarinin/dev-ns-operator/controllers/env"
...
func init() {
	...
	utilruntime.Must(envv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f452c7be.ruslan.marinin",
	})
	if err != nil {
	...
	reconcilers := []ReconcilerInitializer{
		envcontrollers.NewDevNSReconciler(mgr),
