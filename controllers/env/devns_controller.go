...
import (
	...
	"github.com/RuslanMarinin/dev-ns-operator/internal/dependencies"
	"github.com/RuslanMarinin/dev-ns-operator/internal/mutate"
)

// DevNSReconciler reconciles a DevNS object.
type DevNSReconciler struct {
	client.Client
	Name         string
	Log          logr.Logger
...
func NewDevNSReconciler(mgr ctrl.Manager) *DevNSReconciler {
	return &DevNSReconciler{
		Name:         "DevNS",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("DevNS-Controller"),
		FieldManager: "DevNS-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("env").WithName("DevNS"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}

// +kubebuilder:rbac:groups=env.ruslan.marinin,resources=devns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=env.ruslan.marinin,resources=devns/status,verbs=get;update;patch
...
func (r *DevNSReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *DevNSReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &envv1alpha1.DevNS{}
...
func (r *DevNSReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, err := devnsconfig.ConvertWorkload(req.Workload)
	if err != nil {
		return nil, err
	}

	return devnsconfig.Generate(*component, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *DevNSReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *DevNSReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *DevNSReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *DevNSReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *DevNSReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *DevNSReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *DevNSReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *DevNSReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.DevNSCheckReady(r, req)
}
...
func (r *DevNSReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.DevNSMutate(r, req, object)
}

func (r *DevNSReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.InitializePhases()

	baseController, err := ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(predicates.WorkloadPredicates()).
		For(&envv1alpha1.DevNS{}).
		Build(r)
	if err != nil {
